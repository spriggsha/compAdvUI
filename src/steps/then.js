...
import checkContainsPlaceholder from "../support/check/checkContainsPlaceholder";
import checkContainsEmptyString from "../support/check/checkContainsEmptyString";
...
Then(
    /^I expect that (button|element|container) "([^"]*)?"( not)* contains an empty string$/,
    checkContainsEmptyString
);

Then(
    /^I expect that (button|element|container) "([^"]*)?"( not)* contains the placeholder "([^"]*)?"$/,
    checkContainsPlaceholder
);
