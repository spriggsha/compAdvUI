...
let log4j = require('@log4js-node/log4js-api')

let wdioHtmlReporter = require('@rpii/wdio-html-reporter');
// let HtmlReporter = require('@rpii/wdio-html-reporter/HtmlReporter');
...
exports.config = {
    ...
    // from which `wdio` was called. Notice that, if you are calling `wdio` from anf
    ...
    baseUrl: 'http://ec2-34-250-139-60.eu-west-1.compute.amazonaws.com/',
    //
